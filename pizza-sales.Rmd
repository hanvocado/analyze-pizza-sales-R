...
> Thời gian cần thiết:
> Tối thiểu một chu kỳ hoàn chỉnh để xác định mùa vụ.
> Tối thiểu hai chu kỳ để xác nhận tính lặp lại và phân tích chính xác hơn.
Ví dụ:
...
> Từ Mean of squard residuals ta có RMSE bằng khoảng 8.6, giảm 6 đơn vị so với mô hình random forest ban đầu. Và R^2^ bằng 90%, tăng 20%. Chứng tỏ giá trị m~try~ = 2 là giá trị phù hợp để tối ưu mô hình. Chọn đây là mô hình dự đoán cuối cùng.
...
> Kết quả cho thấy Mean of squard residuals thấp và R^2^ cao hơn cả mô hình có m=2. Chọn đây là mô hình dự đoán cuối cùng.
...
Trung bình, giá trị doanh số dự đoán và giá trị thực tế của nó chênh lệch nhau khoảng 8 đơn vị, bằng khoảng 8% giá trị trung bình của sales.
...
1. Winton Clem, Analysis of Data and the Field of Data Science, First edition, 2024.
2. Peter J. Brockwell, Richard A. Davis, Introduction to Time Series and Forecasting, 2nd ed, Nxb. Springer, 2002. 
3. Joshua Noble, What are ARIMA models?, ibm.com, https://www.ibm.com/topics/arima-model, 24/05/2024, truy cập ngày 10/12/2014. 
4. G.E. Box, G.M. Jenkins, G.C. Reinsel and G.M. Ljung, Time series analysis: forecasting and control, 4th ed, John Wiley & Sons, 2016. 
5. Phạm Đình Khánh,  Mô hình ARIMA trong time series, 12/12/2019, https://phamdinhkhanh.github.io/2019/12/12/ARIMAmodel.html#42-ch%E1%BB%89-s%E1%BB%91-aic---akaike-information-criteria, truy cập ngày 12/11/2024. 
6. Prabhakaran Selva, ARIMA Model – Complete Guide to Time Series Forecasting in Python, Machine Learning Plus, machinelearningplus.com, https://www.machinelearningplus.com/time-series/arima-model-time-series-forecasting-python/, 09/12/2019, truy cập ngày 15/11/2024. 
