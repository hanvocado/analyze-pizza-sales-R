...
### 6.3.1. Phân tích doanh số bán hàng của từng bánh pizza
...
Kruskal-Wallis là một kiểm định phi tham số, có thể được sử dụng để so sánh sự biến thiên của doanh thu (sales) giữa các tháng (order_month) cho từng loại pizza.
...
# Kiểm tra kết quả p-value cho mỗi loại pizza
print(kruskal_test)
```

Kết quả p-value khoảng 0.4 trong kiểm định Kruskal-Wallis có thể chỉ ra rằng không có sự khác biệt đáng kể trong doanh thu giữa các tháng đối với từng loại pizza, ít nhất là theo quan điểm thống kê. Điều này có thể xảy ra nếu doanh thu giữa các tháng tương đối ổn định.
...
* Tổng hợp dữ liệu để tính doanh số sản phẩm trong mỗi tháng
...
summary(sales_data)
```
Dữ liệu gồm 435 quan sát với 5 thuộc tính. này là tập hợp các đơn hàng pizza, bao gồm thông tin về giá đơn vị, kích cỡ, loại pizza, tháng đặt hàng và doanh số bán ra. Biến unit_price biểu thị giá của từng loại pizza với phạm vi từ 9.75 đến 35.95, cho thấy sự đa dạng trong mức giá. Biến pizza_size phản ánh kích cỡ pizza với năm mức từ S đến XXL, trong đó kích cỡ phổ biến nhất là S, M, và L, còn kích cỡ XL và XXL ít được đặt hàng hơn.

Biến pizza_category chỉ loại pizza, gồm bốn nhóm chính là Chicken, Classic, Supreme, và Veggie, với loại Classic chiếm tỷ lệ cao nhất trong các đơn hàng. Biến order_month ghi lại thời điểm đặt hàng theo tháng, cho thấy lượng đơn hàng tương đối đều qua các tháng. Cuối cùng, biến sales thể hiện doanh số bán ra, dao động từ 1 đến 444, với trung bình là 115.

Nhìn chung, dữ liệu cho thấy sự đa dạng về giá cả, loại, và kích cỡ pizza, có thể ảnh hưởng đến doanh số bán hàng. Các yếu tố như loại pizza và giá đơn vị có thể đóng vai trò quan trọng trong việc xác định lượng tiêu thụ.

  + Giá trị doanh số trung bình là 115, đây sẽ là cơ sở để đánh giá RMSE của mô hình có tốt không.
...
* Xây dựng mô hình hồi quy tuyến tính dự đoán doanh số sản phẩm
...
### 6.4.5. Dự đoán doanh số bằng Random Forest
...
Thông tin về mô hình:
  ...
  + Giá trị trung bình bình phương phần dư là 2400, cho thấy sai lệch trung bình giữa các giá trị dự đoán và giá trị thực tế của doanh số là khoảng 49 đơn vị.
#  % Var explained: 97.4
Đây là tỷ lệ phần trăm phương sai trong dữ liệu mà mô hình giải thích được. 97.4% có nghĩa là mô hình đã giải thích được 97.4% sự biến động của doanh số dựa trên các đặc trưng đầu vào.
Điều này cho thấy mô hình khá chính xác và có khả năng dự đoán tốt.
...
# Phần 7. Dự đoán doanh thu theo sản phẩm:
...
summary(sales_data)
```
Dữ liệu gồm 1091 quan sát, mỗi quan sát thể hiện doanh thu của một bánh với kích cỡ xác định (hoặc S hoặc M hoặc L hoặc XL hoặc XXL), đơn giá tương ứng, thuộc danh mục nào và doanh số trong một tháng nào đó là bao nhiêu. 
...
## 7.1. Kiểm định giả thuyết:

**a) Kiểm định giá bán có ảnh hưởng tới doanh số không**

**b) Kiểm định kích cỡ có ảnh hưởng tới doanh số không**

**c) kiểm định 

## 7.2. Dự đoán doanh thu theo sản phẩm bằng hồi quy tuyến tính
...
## 7.3. Dự đoán doanh thu theo sản phẩm bằng random forest
